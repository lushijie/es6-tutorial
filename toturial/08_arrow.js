...
* @Last Modified time: 2018-02-08 17:54:01
*/
// ============================================================================
// 箭头函数使用注意点
...
let func = {
  ...
  id: 123456,
  init0() {
    console.log('init0:', this); // func
    console.log('init0 id:', this.id); // 123456
  },
  init: () => {
    console.log('init this:', this); // global
    console.log('init id:', this.id); // undefined
  }
}
...
function Timer() {
  ...
  setInterval(function () {
    this.s2++; // this global 起始值为undefined
  }, 1000);
}
